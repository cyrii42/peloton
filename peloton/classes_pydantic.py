...
class PelotonRide(BaseModel):
    ...
    def serialize_dt(self, start_time: str, _info):
        return datetime.fromtimestamp(start_time, tz=ZoneInfo(EASTERN_TIME)).isoformat()

    @field_serializer('end_time')
    def serialize_dt(self, end_time: str, _info):
        return datetime.fromtimestamp(end_time, tz=ZoneInfo(EASTERN_TIME)).isoformat()
